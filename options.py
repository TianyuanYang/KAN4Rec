...
# Dataloader
################
parser.add_argument('--dataloader_code', type=str, default='kan4rec', choices=DATALOADERS.keys())
...
# Trainer
################
parser.add_argument('--trainer_code', type=str, default='kan4rec', choices=TRAINERS.keys())
# device #
...
# Model
################
parser.add_argument('--model_code', type=str, default='kan4rec', choices=MODELS.keys())
parser.add_argument('--model_init_seed', type=int, default=None)
# KAN4Rec #
parser.add_argument('--max_len', type=int, default=None, help='Length of sequence')
parser.add_argument('--num_items', type=int, default=None, help='Number of total items')
parser.add_argument('--hidden_units', type=int, default=None, help='Size of hidden vectors (d_model)')
parser.add_argument('--num_blocks', type=int, default=None, help='Number of transformer layers')
parser.add_argument('--num_heads', type=int, default=None, help='Number of heads for multi-attention')
parser.add_argument('--dropout', type=float, default=None, help='Dropout probability to use throughout the model')
parser.add_argument('--mask_prob', type=float, default=None, help='Probability for masking items in the training sequence')
